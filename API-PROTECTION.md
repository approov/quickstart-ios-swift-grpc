...
do {
    ...
    // failure due to the attestation being rejected, the ARC and rejectionReasons objects contain
...
> Note you should **NEVER** use this as the only form of protection in your app, this is simply to provide an early indication of failure to your users as a convenience. You must always also have the APIs that are essential to the operation of your app protected with Approov tokens. This is because, although the Approov attestation itself is heavily secured, it may be possible for an attacker to bypass its result or prevent it being called at all.
